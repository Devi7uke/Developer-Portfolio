    ...
    <div className='my-64'>
      ...
      <div ref={ref} className='w-[75%] mx-auto relative'>
        ...
        <ul className='w-full flex flex-col items-start justify-between ml-4'>
          <Details 
            position='Software Engineer' company='Google' companyLink='https://www.google.com' time='2022-Present' address='Mountain View, CA,'
            work="Worked on a team responsible for developing new features for Google's search engine, including improving the accuracy and relevance of search results and developing new tools for data analysis and visualization."
          />
          <Details 
            position='Intern' company='Facebook' companyLink='https://www.facebook.com' time='Summer 2021' address='Menlo Park, CA.'
          ...
          />
          <Details 
            position='Software Developer' company='Amazon' companyLink='https://www.amazon.com' time='2020-2021' address='Seattle, WA.'
            work="Worked on a team responsible for developing Amazon's mobile app, including implementing new features such as product recommendations and user reviews, and optimizing the app's performance and reliability."
          />
          <Details 
            position='Software Developer Intern' company='Microsoft' companyLink='https://www.microsoft.com' time='Summer 2019' address='Redmond, WA.'
          ...
          />
          <Details 
            position='Teaching Assistant' company='MIT' companyLink='https://www.mit.edu/' time='Fall 2018' address='Massachusetts Ave, Cambridge, MA.'
