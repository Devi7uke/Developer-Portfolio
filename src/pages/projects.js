...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
  return (
    <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl p-12 relative rounded-br-2xl lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4' >
      <div className='absolute top-0 left-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2.5rem] bg-dark dark:bg-light rounded-br-3xl xs:-right-2 sm:h-[102%] xs:w-full xs:rounded-[1.5rem]'/>
      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
        ...
        <div className='mt-2 flex items-center'>
          ...
          <Link href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light dark:text-dark dark:bg-light p-2 px-6 text-lg font-semibold sm:px-4 sm:text-base'>Visit Project</Link>
        </div>
      </div>
    </article>
  )
...
const Project = ({title, type, img, link, github}) => {
  return(
    <article className='w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark bg-light dark:border-light dark:bg-dark p-6 relative xs:p-4'>
      <div className='absolute top-0 left-0 -right-3 -z-10 w-[101%] h-[103%] rounded-[2rem] bg-dark dark:bg-light rounded-br-3xl md:-right-2 md:w-[101%] sm:h-[102%] xs:rounded-[1.5rem]'/>
        ...
        <Layout className='pt-16'>
          ...
          <div className='grid grid-cols-12 gap-24 gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
            ...
            <div className='col-span-6 sm:col-span-12'>
              <Project type='Project' title='Crypto Screener Application' img={project1} link='/' github='/'/>
            </div>
            <div className='col-span-6 sm:col-span-12'>
              <Project type='Project' title='React Portfolio Website' img={project1} link='/' github='/'/>
            </div>
            <div className='col-span-12'>
              <FeaturedProject
                type='Featured Project'
